...
export default function ProjectIntroduction() {
      ...
      content: (
        <div className="space-y-4 text-slate-700 leading-relaxed">
          ...
          <div className="bg-gradient-to-r from-amber-500/15 to-orange-500/15 border border-amber-500/30 p-4 rounded-xl my-4 text-center backdrop-blur-sm">
            <span className="text-3xl font-bold text-amber-700">86%</span>
            <p className="text-amber-800 mt-2">Of physical aid trucks entering Gaza fail to reach the people.</p>
          </div>
          <p>
        ...
        <div className="space-y-4 text-slate-700 leading-relaxed">
          ...
          <ul className="space-y-3">
            <li className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 p-4 rounded-xl border border-emerald-500/30 hover:border-emerald-500/50 transition-all duration-300">
              <strong className="text-emerald-700">Cell 1: Damage Assessment.</strong> Identified 19,000 orphaned children (WCNSF). Determined that our absolute priority is Immediate Rescue and medical triage, not long-term rebuilding.
            </li>
            <li className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 p-4 rounded-xl border border-emerald-500/30 hover:border-emerald-500/50 transition-all duration-300">
              <strong className="text-emerald-700">Cell 2: Logistics & The Digital Bypass.</strong> Because 86% of trucks fail, we use Web3/stablecoins to send liquid capital directly to verified social workers inside Gaza, completely skipping border guards.
            </li>
            <li className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 p-4 rounded-xl border border-emerald-500/30 hover:border-emerald-500/50 transition-all duration-300">
              <strong className="text-emerald-700">Cell 3: Van-Based Mesh Network.</strong> To solve the communication gap, mobile vans act as moving internet routers, bouncing signals to satellite gateways so volunteers can coordinate rescues without cell towers.
            </li>
          </ul>
        </div>
      ),
  ...
  return (
    <section className="relative w-full bg-white overflow-hidden font-sans">
      {/* Background Elements */}
      <div className="fixed inset-0 bg-[linear-gradient(to_right,#e5e7eb_1px,transparent_1px),linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-20 pointer-events-none" />
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-cyan-500/5 blur-[120px] rounded-full pointer-events-none" />
        ...
        >
          <div className="text-center max-w-5xl w-full">
            ...
            >
              ...
              />
              <span className="text-sm font-medium text-cyan-600 uppercase tracking-wider">PHC-GAZA Command Center</span>
            </motion.div>
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-slate-900 mb-6 tracking-tight leading-tight">
              Executive <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600">Framework</span>
            </h2>
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="relative w-full max-w-6xl group">
                ...
                {/* Card */}
                <Card className={`relative bg-gradient-to-br ${section.color} backdrop-blur-xl ${section.borderColor} border overflow-hidden shadow-2xl hover:shadow-[0_20px_60px_rgba(0,0,0,0.1)] transition-all duration-500`}>
                  {/* Top Accent Bar */}
                  ...
                  <div className="p-6 lg:p-8 space-y-4">
                    ...
                    {/* Title */}
                    <motion.h3 
                      className={`text-3xl lg:text-4xl font-bold text-slate-900 group-hover:${section.textColor} transition-colors duration-300 leading-tight`}
                      initial={{ opacity: 0, y: 20 }}
                      whileInView={{ opacity: 1, y: 0 }}
